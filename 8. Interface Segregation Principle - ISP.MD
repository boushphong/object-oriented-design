...
- The solution [Good Design](#diagram-B) to this whole mess would be to pull out a substitute teacher from this inheritance relationship because it simply is not a teacher as per our definition of what a teacher what a real teacher whose behavior should be.
